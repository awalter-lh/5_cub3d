...
void	init_test_map(t_mlx *mlx)
{
	...
	mlx->map.map[0] = "111111 11111111";
	mlx->map.map[1] = "101001 10000001";
	mlx->map.map[2] = "101001 10000001";
	mlx->map.map[3] = "101001110000001";
	mlx->map.map[4] = "100000000011111";
	mlx->map.map[5] = "10000000001111 ";
	mlx->map.map[6] = "11111000000001 ";
	mlx->map.map[7] = "10001000000001 ";
	mlx->map.map[8] = "10000000001111 ";
	mlx->map.map[9] = "11111111111    ";
	mlx->map.map[10] = NULL;
